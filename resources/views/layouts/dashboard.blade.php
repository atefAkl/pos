        ...
        <div class="wrapper d-flex">
            ...
            <nav id="sidebar" class="bg-dark text-white">
                ...
                <ul class="list-unstyled p-3">
                    <li class="mb-2">
                        <a href="{{ route('home') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('home') ? 'bg-primary' : 'hover-bg-primary' }}">
                            <i class="fas fa-home me-2"></i> الرئيسية
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('products.index') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('products.*') ? 'bg-primary' : 'hover-bg-primary' }}">
                            <i class="fas fa-box me-2"></i> المنتجات
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('categories.index') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('categories.*') ? 'bg-primary' : 'hover-bg-primary' }}">
                            <i class="fas fa-tags me-2"></i> الفئات
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('customers.index') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('customers.*') ? 'bg-primary' : 'hover-bg-primary' }}">
                            <i class="fas fa-users me-2"></i> العملاء
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('pos.index') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('pos.*') ? 'bg-primary' : 'hover-bg-primary' }}">
                            <i class="fas fa-cash-register me-2"></i> نقطة البيع
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('invoices.index') }}"
                            class="text-white text-decoration-none d-block p-2 rounded {{ request()->routeIs('invoices.*') ? 'bg-primary' : 'hover-bg-primary' }}">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&background=random" alt="" width="32" height="32"
